    ...
    v.onload = function() {
        ...
        window.voiceflow.chat.load({
            ...
            const vfSH = document.querySelector('#vfchat')
            if (vfSH && vfSH.shadowRoot) {
                const vfSR = vfSH.shadowRoot;
                const vfSRobs = new MutationObserver((mutations, obs) => {
                    const vfrcH = vfSR.querySelector('.vfrc-header');
                ...
                vfSRobs.observe(vfSR, { childList: true, subtree: true });
            }   
